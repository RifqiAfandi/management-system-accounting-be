...
async function createSalesByCategory(req, res) {
    try {
        const { inputDate, salesCategoryId, qtyTerjual, revenue, hpp, margin } = req.body;
        ...
        const salesWithCategory = await Sales_by_category.findByPk(newSalesEntry.id, {
            include: [{
...
async function updateSalesByCategory(req, res) {
    try {
        ...
        if (inputDate !== undefined) updateData.inputDate = inputDate;
        if (salesCategoryId !== undefined) updateData.salesCategoryId = salesCategoryId;
...
async function deleteSalesByCategory(req, res) {
    try {
        ...
        const deletedData = {
            id: salesEntry.id,
            inputDate: salesEntry.inputDate,
